...
/* 首页默认停留和区域切换节拍。 */
#define OLED_UI_HOME_DEFAULT_MS        1000U
#define OLED_UI_REGION_TIMER_MIN_MS    4000U
#define OLED_UI_REGION_TIMER_MAX_MS    6000U
...
#define OLED_UI_SHUTDOWN_CONFIRM_MS    2500U
